...
function render(variables = {}) {
  ...
  if (variables.twitter) variables.twitter;
  if (variables.github) variables.github;
  if (variables.linkedin) variables.linkedin;
  if (variables.instagram) variables.instagram;
